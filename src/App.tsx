...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-canvas text-ink transition-colors dark:bg-slate-950 dark:text-slate-100">
      ...
      <footer className="mt-14 border-t border-line px-5 py-6 text-center text-xs text-muted dark:border-slate-800 dark:text-slate-400">© 2026 Secretaria de Inteligência Artificial, Economia Digital, Ciência, Tecnologia e Inovação — SIA</footer>
    </div>
  )
}
